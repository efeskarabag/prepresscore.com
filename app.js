...
const translations = {
    ...
    en: {
        ...
        "hero-badge": "Version v1.1.2 Active",
        ...
        "docs-content-release": '<h5>Version v1.1.2 (Current)</h5><p>- Secured the initial Node.js require sequence in the extension script, preventing auto-updater crashes if third-party modules are missing, and establishing a self-healing update engine.</p><br><h5>Version v1.1.1</h5><p>- Resolved a dependency error (Cannot find module) when starting the extension after Windows installation.</p><p>- Fixed a bug preventing the cancel button from working in the macOS installer pre-check dialog, and updated the dialog buttons and texts to be more professional.</p><br><h5>Version v1.1.0</h5><p>- Added a graceful shutdown warning prompt during installation if Adobe Illustrator is open, asking the user to save their work and close the application.</p><br><h5>Version v1.0.9</h5><p>- Resolved a Node.js module import error on Windows systems when paths contain percent-encoded spaces (%20) or leading slashes.</p><p>- Optimized path resolution and zip extraction for the automatic update utility on Windows and macOS runtimes.</p>',
