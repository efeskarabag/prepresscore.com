...
const translations = {
    tr: {
        ...
        "docs-content-release": '<h5>Sürüm v1.1.1 (Güncel)</h5><p>- Windows kurulumunun ardından eklenti başlatılırken oluşan bağımlılık hatası (Cannot find module) giderildi.</p><p>- macOS yükleme ekranındaki kapatma uyarısının iptal edilmesini engelleyen hata çözüldü, bekleme butonları ve diyalog mesajları daha profesyonel hale getirildi.</p><br><h5>Sürüm v1.1.0</h5><p>- Kurulum sırasında Adobe Illustrator açık ise kullanıcıya çalışmalarını kaydetmesi için uyarı gösteren ve kapatılmasını bekleyen güvenli kapatma mekanizması eklendi.</p><br><h5>Sürüm v1.0.9</h5><p>- Windows işletim sisteminde eklenti dizininde boşluk ve yüzde karakteri (%20) bulunması durumunda oluşan Node.js modül yükleme hatası giderildi.</p><p>- Otomatik güncelleme altyapısının yol çözümleme ve klasör çıkarma adımları Windows/macOS için optimize edildi.</p><br><h5>Sürüm v1.0.8</h5><p>- Eklentinin ilk açılışta demo lisans anahtarını otomatik doldurması engellendi. Giriş yapılan son lisans anahtarı hafızada tutulacak şekilde güncellendi.</p><p>- Donanım doğrulamalı lisans oturumlarının 24 saat sonra zaman aşımına uğraması engellenerek kalıcı oturum yapısı sağlandı.</p>',
    ...
    en: {
        ...
        "hero-badge": "Version v1.1.1 Active",
        ...
        "docs-content-release": '<h5>Version v1.1.1 (Current)</h5><p>- Resolved a dependency error (Cannot find module) when starting the extension after Windows installation.</p><p>- Fixed a bug preventing the cancel button from working in the macOS installer pre-check dialog, and updated the dialog buttons and texts to be more professional.</p><br><h5>Version v1.1.0</h5><p>- Added a graceful shutdown warning prompt during installation if Adobe Illustrator is open, asking the user to save their work and close the application.</p><br><h5>Version v1.0.9</h5><p>- Resolved a Node.js module import error on Windows systems when paths contain percent-encoded spaces (%20) or leading slashes.</p><p>- Optimized path resolution and zip extraction for the automatic update utility on Windows and macOS runtimes.</p><br><h5>Version v1.0.8</h5><p>- Prevented the extension from pre-filling the demo license key on startup. Changed the panel to remember and pre-fill the last successfully used license key.</p><p>- Prevented hardware-locked license sessions from expiring after 24 hours, establishing a persistent session structure.</p>',
