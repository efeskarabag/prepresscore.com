...
const translations = {
    tr: {
        ...
        "docs-content-docs": '<h5>Kurulum Adımları</h5><p>1. İndirilen pakete (.exe veya .pkg) <strong>sağ tıklayarak</strong> açın (macOS üzerinde Control tuşuna basılı tutarak tıklayıp Aç diyebilirsiniz).</p><p>2. Illustrator uygulamanızı yeniden başlatın.</p><p>3. Üst menüden <strong>Pencere &gt; Uzantılar &gt; Prepress Core</strong> yolunu izleyin.</p><br><h5>Lisans Aktivasyonu</h5><p>Size iletilen lisans anahtarını panel arayüzüne girip onaylayın. Sistem donanım kimliğinizi (HWID) otomatik olarak lisansınızla eşleştirecektir.</p>',
        "docs-title-faq": "Sıkça Sorulan Sorular",
        "docs-content-faq": '<div class="faq-accordion"><div class="faq-item"><button class="faq-trigger"><span>1. CEP panel / eklenti nedir ve normal scriptlerden farkı nedir?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Adobe Illustrator içerisinde tıpkı &quot;Katmanlar&quot; veya &quot;Renk&quot; paneli gibi yerleşik olarak çalışan gelişmiş bir arayüzdür. Dışarıdan script (.jsx) dosyası seçip çalıştırmakla uğraşmazsınız; tüm araçlar tek pencerede, görsel butonlarla elinizin altındadır.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>2. Hayatımda hiç eklenti kullanmadım, baskı öncesi (prepress) işlemlerinde bana nasıl yardımcı olur?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Normalde saatler süren manuel hizalama, kesim çizgisi (kros) ekleme, renk analizi, görsel çözünürlük kontrolleri ve taşma payı verme gibi kritik işleri tek tıklamayla saniyeler içinde hatasız yapar. Hata yapma riskinizi sıfıra indirerek matbaa baskı süreçlerinde oluşabilecek fireleri önler.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>3. Donanım Kilidi (HWID) nedir ve neden gereklidir? Bilgisayarıma zarar verir mi?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>HWID, lisansınızın sadece size ait bilgisayarda çalışmasını sağlayan güvenli bir donanım kimliğidir. Kesinlikle bilgisayarınıza zarar vermez veya kişisel verilerinizi toplamaz. Bankacılık uygulamalarının telefonunuzu eşlemesine benzer şekilde, eklenti lisansının izinsiz kopyalanmasını veya çalınmasını önler.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>4. İnternet bağlantım koptuğunda eklentiyi kullanmaya devam edebilir miyim?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Evet. Sistemimiz matbaalardaki internet kesintilerini öngörerek 24 saatlik çevrimdışı toleransı ile tasarlanmıştır. İnternetiniz tamamen kopsa bile, son bağlantıdan itibaren 24 saat boyunca tüm özellikleri şifreli yerel önbellek sayesinde kesintisiz kullanabilirsiniz.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>5. Illustrator sürümünü güncellersem veya yeni bir bilgisayara geçersem ne olur?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Panelimiz Adobe güncellemelerini arka planda otomatik takip eder ve kendini uyumlu hale getirir. Yeni bilgisayara geçişte ise tek yapmanız gereken, destek ekibimizle iletişime geçerek eski cihazınızın donanım kaydını (HWID) sıfırlatıp yeni cihazınızda eklentiyi tekrar aktifleştirmektir. Destek ekibimiz bu sıfırlama işlemini arka planda anında gerçekleştirmektedir.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>6. Güvenlik ve kod koruması nasıl sağlanıyor? Tasarımlarım veya dosyalarım dışarı aktarılıyor mu?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Kesinlikle hayır. Panel, tasarımlarınızı veya dosyalarınızı hiçbir şekilde dış sunuculara göndermez; tüm işlemler yerel olarak bilgisayarınızda gerçekleşir. Sunucu ile sadece şifreli lisans doğrulaması ve script güncellemeleri alışverişi yapılır. Kodlarımız ise RAM üzerinde anlık olarak çözülerek çalıştırıldığı için üçüncü şahıslar tarafından kopyalanamaz veya çalınamaz.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>7. Çoklu kullanıcı ve departman bazlı yetkilendirme sistemi nasıl çalışır?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Illustrator içindeki eklenti paneliniz, lisans anahtarınıza tanımlanan departman veya rol etiketlerini (örneğin &quot;prepress&quot;, &quot;design&quot; veya &quot;indigo&quot;) sunucumuzdan otomatik olarak sorgular. Bu etiketler, destek ekibimiz tarafından lisansınıza arka planda tanımlanır ve panelinizde sadece yetkili olduğunuz eklenti modüllerinin dinamik olarak listelenmesini sağlar. Böylece matbaanızdaki farklı ekiplerin sadece kendi iş akışlarına özel araçları görmesi sağlanır ve gereksiz arayüz kalabalığı önlenir.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>8. Prepress Core hangi Adobe Illustrator sürümleriyle uyumludur?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Platformumuz Adobe Illustrator CC 2018 ve üzeri tüm sürümlerle (en güncel Illustrator 2026 dahil) tam uyumludur. Hibrit mimarisi (HTML5/CEF + ExtendScript JSX) sayesinde hem Windows hem de macOS (Intel &amp; Apple Silicon M1/M2/M3) işletim sistemlerinde kararlı bir şekilde çalışır.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>9. RAM üzerinde şifre çözme (RAM Decrypt) performansı etkiler mi?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Hayır. Şifre çözme işlemi yerel kriptografik kütüphanelerimizle bellek üzerinde milisaniyeler içinde gerçekleşir. Kodlar diske hiç yazılmadan doğrudan ExtendScript motoruna beslendiği için Illustrator\'ın normal çalışma performansında herhangi bir gecikme veya yavaşlama hissettirmez.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>10. Hata yönetimi ve günlük (debugging/log) sistemi nasıl çalışır?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Eklentimiz, arka planda çalışan ExtendScript motoru ve JavaScript arayüzü arasındaki tüm veri akışını denetler. Oluşabilecek Illustrator API hataları veya ağ zaman aşımı gibi durumlar yakalanarak şifreli hata günlüklerine kaydedilir ve simülatör terminalinde anlık izlenebilir. Bu sayede hatalar matbaa ortamında iş aksamadan hızla tespit edilip giderilir.</p></div></div></div></div>',
        "docs-title-release": "Sürüm Notları",
        "docs-content-release": '<h5>Sürüm v1.0.8 (Güncel)</h5><p>- Eklentinin ilk açılışta demo lisans anahtarını otomatik doldurması engellendi. Giriş yapılan son lisans anahtarı hafızada tutulacak şekilde güncellendi.</p><p>- Donanım doğrulamalı lisans oturumlarının 24 saat sonra zaman aşımına uğraması engellenerek kalıcı oturum yapısı sağlandı.</p><br><h5>Sürüm v1.0.7</h5><p>- Windows ve macOS sistemlerde eklenti dizininde boşluk ve özel karakter bulunması durumunda oluşan Node.js modül yükleme ve yol çözümleme hataları giderildi.</p><br><h5>Sürüm v1.0.6</h5><p>- macOS sistemlerde eklenti dizininde boşluk (Application Support) olması durumunda oluşan URL çözme ve dosya yolu erişim hatası düzeltildi.</p><br><h5>Sürüm v1.0.5</h5><p>- Windows işletim sisteminde Illustrator CEP eklentisi başlatılırken oluşan Node.js dosya yolu erişim hatası (__dirname çakışması) giderildi ve şifreli script çalıştırma kararlılığı artırıldı.</p><br><h5>Sürüm v1.0.4</h5><p>- Yoğun SVG yolları işlenirken CEF (Chromium Embedded Framework) konteynerinde oluşan IPC köprüsü bellek sızıntısı giderildi.</p><p>- JSX HostScript motoru değerlendirmesi ile CEP JS asenkron geri çağırma (callback) iş parçacıkları arasındaki senkronizasyon yarış durumu (race-condition) çözüldü.</p><p>- Adobe Illustrator 2026 koyu arayüz modu senkronizasyonunda oluşan renk paleti dönüştürme matrisi sapması (offset) düzeltildi.</p>',
    ...
    en: {
        ...
        "hero-badge": "Version v1.0.8 Active",
        ...
        "docs-content-docs": '<h5>Installation Steps</h5><p>1. <strong>Right-click</strong> the downloaded installer file (.exe or .pkg) and select Open (on macOS, hold Control and click Open).</p><p>2. Restart Adobe Illustrator.</p><p>3. Go to <strong>Window &gt; Extensions &gt; Prepress Core</strong> to open the panel.</p><br><h5>License Activation</h5><p>Enter your assigned license key into the panel. The system will automatically bind your Hardware ID (HWID) to your license.</p>',
        "docs-title-faq": "Frequently Asked Questions",
        "docs-content-faq": '<div class="faq-accordion"><div class="faq-item"><button class="faq-trigger"><span>1. What is a CEP panel / extension and how is it different from normal scripts?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>It is an advanced interface that runs natively inside Adobe Illustrator, just like the &quot;Layers&quot; or &quot;Color&quot; panels. You don\'t have to deal with manually selecting and running external script (.jsx) files; all tools are at your fingertips with visual buttons in a single panel.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>2. I have never used an extension before, how will it help me in prepress operations?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>It flawlessly performs critical tasks that normally take hours—such as manual alignment, adding crop marks, color analysis, visual resolution checks, and bleed margins—in seconds with a single click. It eliminates your risk of making mistakes, preventing waste in printing press production.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>3. What is a Hardware Lock (HWID) and why is it necessary? Will it harm my computer?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>HWID is a secure hardware identifier that ensures your license only runs on your own computer. It absolutely does not harm your computer or collect personal data. Similar to how banking apps bind to your phone, it prevents unauthorized copying or theft of the extension license.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>4. Can I continue to use the extension if my internet connection is lost?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Yes. Our system is designed with a 24-hour offline tolerance, anticipating internet outages in printing studios. Even if your internet is completely disconnected, you can use all features uninterrupted for 24 hours from the last connection using an encrypted local cache.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>5. What happens if I update Adobe Illustrator or switch to a new computer?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Our panel automatically tracks Adobe updates in the background and adapts itself. When switching to a new computer, simply contact our support team to reset your old computer\'s hardware binding (HWID) and reactivate the extension on your new device. Our support team can instantly reset mappings in the background.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>6. How is security and code protection provided? Are my designs or files exported?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Absolutely not. The panel never sends your designs or files to external servers; all operations take place locally on your computer. Only encrypted license verification and script updates are exchanged with the server. Our codes are decrypted and executed directly in RAM, so they cannot be copied or stolen by third parties.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>7. How does the multi-user and department-based authorization system work?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Your extension panel inside Illustrator automatically queries the department or role tags (such as &quot;prepress&quot;, &quot;design&quot;, or &quot;indigo&quot;) assigned to your license key from our server. These tags are defined for your license by our support team, dynamically listing only the extension modules you are authorized to use. This ensures different teams in your studio see only the tools specific to their workflow, preventing interface clutter.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>8. Which Adobe Illustrator versions is Prepress Core compatible with?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Our platform is fully compatible with Adobe Illustrator CC 2018 and above, including the latest Illustrator 2026. Thanks to its hybrid architecture (HTML5/CEF + ExtendScript JSX), it runs stably on both Windows and macOS (Intel &amp; Apple Silicon M1/M2/M3) operating systems.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>9. Does in-memory RAM Decryption affect execution performance?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>No. The decryption process takes place in memory in milliseconds using native cryptographic libraries. Since codes are fed directly into the ExtendScript engine without ever being written to disk, it does not cause any latency or slowdown in Illustrator\'s normal performance.</p></div></div></div><div class="faq-item"><button class="faq-trigger"><span>10. How do the error handling and debugging log systems work?</span><span class="faq-icon">+</span></button><div class="faq-content"><div class="faq-content-inner"><p>Our extension monitors all data flow between the background ExtendScript engine and the JavaScript interface. Any Illustrator API errors or network timeouts are captured, recorded in encrypted logs, and can be tracked in real-time in the simulator terminal. This allows rapid debugging in production without interrupting active workflows.</p></div></div></div></div>',
        "docs-title-release": "Release Notes",
        "docs-content-release": '<h5>Version v1.0.8 (Current)</h5><p>- Prevented the extension from pre-filling the demo license key on startup. Changed the panel to remember and pre-fill the last successfully used license key.</p><p>- Prevented hardware-locked license sessions from expiring after 24 hours, establishing a persistent session structure.</p><br><h5>Version v1.0.7</h5><p>- Resolved Node.js module loading and path resolution issues when the extension path contains spaces or special characters on Windows and macOS runtimes.</p><br><h5>Version v1.0.6</h5><p>- Resolved a URL decoding and file path resolution issue on macOS CEP runtimes when the extension path contains spaces (Application Support).</p><br><h5>Version v1.0.5</h5><p>- Resolved a Node.js folder path resolution issue (__dirname mismatch) on Windows CEP runtimes, stabilizing the execution of encrypted modules.</p><br><h5>Version v1.0.4</h5><p>- Fixed an IPC bridge memory leak inside the CEF container (Chromium Embedded Framework) when rendering intensive SVG paths.</p><p>- Resolved a synchronization race-condition between JSX HostScript engine evaluation and CEP JS async callback threads.</p><p>- Corrected color palette conversion matrix offset for Adobe Illustrator 2026 dark UI mode synchronization.</p>',
