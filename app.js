...
const translations = {
    ...
    en: {
        ...
        "hero-badge": "Version v1.0.7 Active",
        ...
        "docs-content-release": '<h5>Version v1.0.7 (Current)</h5><p>- Resolved Node.js module loading and path resolution issues when the extension path contains spaces or special characters on Windows and macOS runtimes.</p><br><h5>Version v1.0.6</h5><p>- Resolved a URL decoding and file path resolution issue on macOS CEP runtimes when the extension path contains spaces (Application Support).</p><br><h5>Version v1.0.5</h5><p>- Resolved a Node.js folder path resolution issue (__dirname mismatch) on Windows CEP runtimes, stabilizing the execution of encrypted modules.</p><br><h5>Version v1.0.4</h5><p>- Fixed an IPC bridge memory leak inside the CEF container (Chromium Embedded Framework) when rendering intensive SVG paths.</p><p>- Resolved a synchronization race-condition between JSX HostScript engine evaluation and CEP JS async callback threads.</p><p>- Corrected color palette conversion matrix offset for Adobe Illustrator 2026 dark UI mode synchronization.</p>',
