...
const translations = {
    tr: {
        ...
        "docs-content-release": '<h5>Sürüm v1.1.0 (Güncel)</h5><p>- Kurulum sırasında açık olan Adobe Illustrator uygulamasının otomatik olarak kapatılması zorlanarak kurulumun eksiksiz tamamlanması sağlandı.</p><br><h5>Sürüm v1.0.9</h5><p>- Windows işletim sisteminde eklenti dizininde boşluk ve yüzde karakteri (%20) bulunması durumunda oluşan Node.js modül yükleme hatası giderildi.</p><p>- Otomatik güncelleme altyapısının yol çözümleme ve klasör çıkarma adımları Windows/macOS için optimize edildi.</p><br><h5>Sürüm v1.0.8</h5><p>- Eklentinin ilk açılışta demo lisans anahtarını otomatik doldurması engellendi. Giriş yapılan son lisans anahtarı hafızada tutulacak şekilde güncellendi.</p><p>- Donanım doğrulamalı lisans oturumlarının 24 saat sonra zaman aşımına uğraması engellenerek kalıcı oturum yapısı sağlandı.</p><br><h5>Sürüm v1.0.7</h5><p>- Windows ve macOS sistemlerde eklenti dizininde boşluk ve özel karakter bulunması durumunda oluşan Node.js modül yükleme ve yol çözümleme hataları giderildi.</p>',
    ...
    en: {
        ...
        "hero-badge": "Version v1.1.0 Active",
