...
const translations = {
    ...
    en: {
        ...
        "docs-content-release": '<h5>Version v1.0.8 (Current)</h5><p>- Prevented the extension from pre-filling the demo license key on startup. Changed the panel to remember and pre-fill the last successfully used license key.</p><p>- Prevented hardware-locked license sessions from expiring after 24 hours, establishing a persistent session structure.</p><br><h5>Version v1.0.7</h5><p>- Resolved Node.js module loading and path resolution issues when the extension path contains spaces or special characters on Windows and macOS runtimes.</p><br><h5>Version v1.0.6</h5><p>- Resolved a URL decoding and file path resolution issue on macOS CEP runtimes when the extension path contains spaces (Application Support).</p><br><h5>Version v1.0.5</h5><p>- Resolved a Node.js folder path resolution issue (__dirname mismatch) on Windows CEP runtimes, stabilizing the execution of encrypted modules.</p>',
